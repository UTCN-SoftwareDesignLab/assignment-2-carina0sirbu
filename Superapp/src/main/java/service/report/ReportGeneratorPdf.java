    ...
    public void generateReport() {
        ...
        try {
            ...
            for(Book book: bookList) {
                ...
                pageContentStream.newLine();
                pageContentStream.showText("Author name: " + book.getAuthorName());
                pageContentStream.newLine();
        ...
        try {
            document.save("E:/Poli is love/3rd yr/2nd sem/SD/assignment-2-carina0sirbu/Superapp/BooksOutOfStock.pdf");
        } catch (IOException e) {
            e.printStackTrace();
        }
