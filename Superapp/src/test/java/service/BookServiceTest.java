...
public class BookServiceTest {
    ...
    public void setUp() {
        ...
        book = new Book("Carte de test", "Capsunica", "sanatate", 5, 23);
        bookList.add(book);
        ...
        Mockito.when(bookRepository.save(new Book("Bombonici", "Sugar Land", "dulce", 300, 55)))
                                    .thenReturn(new Book());
    }
    ...
    public void create() {
        ...
        Assert.assertEquals(book.getAuthorName(), "Sugar Land");
